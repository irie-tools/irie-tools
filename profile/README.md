...
Small, standalone tools — the porch of a larger ecosystem. Each one does one job well and works on its own; together they connect through [versioned JSON contracts](https://github.com/irie-tools/irie-contracts), not shared code.
...
Everything above is free and stays free. It's how we build in the open, invite outside contributors, and show our work — while the products these tools connect to (hosting, automation, the full Irie ecosystem) live at [iriecommerce.com](https://iriecommerce.com).
